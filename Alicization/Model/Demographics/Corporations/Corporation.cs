...
{
    internal class Corporation : ICorporation
    {
        ...
        {
            entityName = Randomness.SampleInt().ToString();
            entityType = EntityType.Corporation;
            JoinCorporations();
        }

        internal void CreateNewCorporation(IEnumerable<Player> members)
        {
            Corporation corporation = new Corporation();
            foreach (Player member in members) {
                CorporationEntity accessRight = new CorporationEntity(corporation, member);
        ...
        private void JoinCorporations()
        {
            World.corporations.Add(this);
        }
