...
{
    class LabourMarketTransaction : ITransaction
    {
        ...
        internal LabourMarketTransaction(WealthEntityDouble pair, double isk)
        {
            turn = Time.Now();
        ...
        internal LabourMarketTransaction(int t, WealthEntityDouble pair, double isk)
        {
            turn = t;
            wealthEntityDouble = pair;
            amount = isk;
